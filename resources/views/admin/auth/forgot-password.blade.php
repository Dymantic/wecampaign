...
<div class="max-w-md mx-auto">
    ...
    @if(session()->has('status'))
        <div class="max-w-sm mx-auto py-8 px-4 bg-green flex">
            ...
            <p class="text-white text-xl">Your password reset link has been sent to your email. If you would like to send another link, just reuse the form below.</p>
        </div>
    @endif
    ...
    <div>
        <form action="/admin/forgot-password" method="POST" class="max-w-sm mx-auto my-8">
            ...
            <div class="form-group">
                <button type="submit" class="w-full block my-4 bg-green text-white uppercase tracking-wide h-12">Send Reset Link</button>
            </div>
        </form>
    </div>
</div>
