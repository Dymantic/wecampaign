<section id="organizations">
    <div class="max-w-lg mx-auto my-28">
        ...
        <div class="flex flex-col md:flex-row min-h-56 bg-off-white rounded md:flex-row-reverse mx-4 md:mx-0 shadow my-12">
        ...
        <div class="flex flex-col md:flex-row min-h-56 bg-off-white rounded mx-4 md:mx-0 shadow my-12">
            <div class="w-full md:w-1/2 flex justify-center items-center pt-6 md:pt-0">
