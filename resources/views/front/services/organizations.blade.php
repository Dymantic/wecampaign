...
<div class="bg-off-white max-w-narrow mx-auto min-h-64 flex flex-col rounded shadow my-12">
    <div class="flex justify-center items-center pt-4">
        @include('front.svgicons.organization_1', ['svgClass' => 'h-8 md:h-12'])
    </div>
...
<div class="bg-off-white max-w-narrow mx-auto min-h-64 flex flex-col rounded shadow my-12">
    <div class="flex justify-center items-center pt-4">
        @include('front.svgicons.organization_2', ['svgClass' => 'h-8 md:h-12'])
    </div>
    <div class="flex flex-col items-center justify-center p-8 pt-4">
...
<div class="bg-off-white max-w-narrow mx-auto min-h-64 flex flex-col rounded shadow my-12">
    <div class="flex justify-center items-center pt-4">
        @include('front.svgicons.organization_3', ['svgClass' => 'h-8 md:h-12'])
    </div>
    <div class="flex flex-col items-center justify-center p-8 pt-4">
...
<div class="bg-off-white max-w-narrow mx-auto min-h-64 flex flex-col rounded shadow my-12">
    <div class="flex justify-center items-center pt-4">
        @include('front.svgicons.organization_4', ['svgClass' => 'h-8 md:h-12'])
    </div>
    <div class="flex flex-col items-center justify-center p-8 pt-4">
