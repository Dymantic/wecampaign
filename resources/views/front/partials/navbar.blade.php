<div class="main-navbar fixed pin-t w-full flex justify-between items-center h-12 md:h-24 px-4 md:px-8">
    <div class="">
        <a href="{{ localRoute('/') }}">@include('front.svgicons.home_icon')</a>
    </div>
    <div class="flex-1 flex justify-end items-center">
        <a class="no-underline hover:underline uppercase nav-font mx-4 md:mx-8" href="{{ localRoute('/services') }}">{{ trans('navbar.links.services') }}</a>
        <a class="no-underline hover:underline uppercase nav-font mx-4 md:mx-8" href="{{ localRoute('/team') }}">{{ trans('navbar.links.team') }}</a>
        <a class="no-underline hover:underline uppercase nav-font mx-4 md:mx-8" href="{{ localRoute('/contact') }}">
