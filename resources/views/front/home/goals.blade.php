<section class="">
    <div class="max-w-xl px-4 mx-auto py-28">
        ...
        <div class="flex flex-col md:flex-row justify-between items-stretch mx-4 md:mx-0">
            <div class="bg-off-white flex-1 my-8 md:my-0 flex flex-col items-center mr-0 md:mr-4 bg-white text-blue-dark shadow rounded py-4 px-8 items-center">
            ...
            <div class="bg-off-white flex-1 my-8 md:my-0 flex flex-col items-center mx-0 md:mx-4 bg-white text-blue-dark shadow rounded py-4 px-8">
            ...
            <div class="bg-off-white flex-1 my-8 md:my-0 flex flex-col items-center ml-0 md:ml-4 bg-white text-blue-dark shadow rounded py-4 px-8">
